...
// Load Inter font with multiple weights for better typography
const inter = Inter({
  subsets: ["latin"],
...
const FlowerPage: React.FC = () => {
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-[#FFF5E4] flex flex-col items-center justify-center overflow-hidden text-[#FF9494] ${inter.className}`}
      >
        <div className="flex flex-col items-center justify-center h-full w-full relative">
          {/* Text container with padding and background for separation */}
          <div
            id="thankyou"
            className="w-full text-center mb-20 md:mb-32 z-10 relative px-4 md:px-6 py-6 bg-[#FFF5E4]/90 rounded-lg"
          >
            <h1 className="text-3xl md:text-5xl block mb-3 md:mb-4 font-black tracking-tight">Happy Women's Day!</h1>
            <p className="text-xl md:text-2xl font-medium">Lọ Hoa này dành tặng mẹ.</p>
          </div>

          {/* Increased top margin for better separation */}
          <div className="flower scale-75 md:scale-100 mt-16 relative z-0">
